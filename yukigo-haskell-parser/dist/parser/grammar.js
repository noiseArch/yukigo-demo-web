...
import { parseFunction, parsePrimary, parseDataExpression, parseConditional, parseInfixApplication, parseDataDeclaration, parseApplication, parseExpression, parseCompositionExpression, parseTypeAlias, parseFunctionType, parseLambda } from "../utils/helpers.js";
const filter = d => {
...
const grammar = {
    ...
    ParserRules: [
        ...
        { "name": "application_type", "symbols": ["simple_type", "application_type$ebnf$1"], "postprocess": (d) => d[1].length === 0 ? d[0] : { type: "TypeApplication", base: d[0], args: d[1].map(x => x[1]) }
        },
