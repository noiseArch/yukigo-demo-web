import { ApplicationExpression, CompositionExpression, FunctionDeclaration, FunctionGroup, FunctionTypeSignature, InfixApplicationExpression, LambdaExpression, TypeAlias, TypeNode } from "./paradigms/functional.js";
export type Modify<T, R> = Omit<T, keyof R> & R;
export type YukigoPrimitive = "YuNumber" | "YuString" | "YuChar" | "YuBoolean" | "YuList" | "YuNull" | "YuUndefined" | "YuSymbol";
export type PrimitiveValue = number | boolean | string | symbol | null | undefined;
/**
...
export type Primitive = NumberPrimitive | BooleanPrimitive | CharPrimitive | StringPrimitive | NullPrimitive | UndefinedPrimitive | SymbolPrimitive | ListPrimitive;
/**
...
export type Operation = ArithmeticOperation | ComparisonOperation | LogicalOperation | BitwiseOperation | StringOperation;
/**
...
export type BodyExpression = Primitive | Operation | TupleExpression | ControlFlowConditional | ConsExpression | DataExpression | CompositionExpression | LambdaExpression | ApplicationExpression | InfixApplicationExpression;
...
export declare function traverse(node: any, visitor: Visitor, parent?: any): void;
export {};
